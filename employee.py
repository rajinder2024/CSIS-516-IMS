...
class employeeClass:
    def __init__(self, root):  
        ...
        txt_search= Button(Searchframe,text="Search",command=self.search,font=("goudy old style",15),bg="gray",fg="white",cursor="hand2").place(x=410,y=9, width=150,height=30)

        ####### Title ####
        title = Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#0f4d7d",fg="white",cursor="hand2").place(x=50,y=100, width=1000)
        ...
        ######## Button
        btn_add= Button(self.root,text="Save", command=self.add,font=("goudy old style",15),bg="gray",fg="white",cursor="hand2").place(x=500,y=305, width=110,height=28)
        ...
        btn_delete= Button(self.root,text="Delete",command=self.delete, font=("goudy old style",15),bg="Green",fg="white",cursor="hand2").place(x=740,y=305, width=110,height=28)
        btn_clear= Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="red",fg="white",cursor="hand2").place(x=860,y=305, width=110,height=28)
        ...
        self.EmployeeTable.heading("pass",text="Passward")
