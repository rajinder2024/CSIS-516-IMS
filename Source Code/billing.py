...
class BillClass:
    def __init__(self, root):  
        ...
        self.var_search=StringVar()     ## variable
        ProductFrame2 = Frame(ProductFrame1, bd=2, relief=RIDGE, bg="white")
        ProductFrame2.place(x=2, y=42, width=398, height=90)

        lbl_search=Label(ProductFrame2,text="Search Product | By Name",font=("times ne roman",15,"bold"),bg="white",fg="green").place(x=2,y=5)
        lbl_search=Label(ProductFrame2,text="Product Name",font=("times new roman",15,"bold"),bg="white").place(x=2, y=40)
        txt_search=Entry(ProductFrame2,textvariable=self.var_search,font=("times ne roman",15,"bold"),bg="white").place(x=128, y=47,width=150,height=22)
        btn_search=Button(ProductFrame2, text="Search",command=self.search,font=("goudy old style", 20),bg="#2196f3", fg="white",cursor="hand2").place(x=285,y=45,width=100,height=25)
        btn_show_all=Button(ProductFrame2, text="Show All",command=self.show, font=("goudy old style", 20),bg="#083531", fg="white",cursor="hand2").place(x=285,y=10,width=100,height=25)

        ###########  Pruduct details frame
        ...
        ##########  Customer Frame
        self.var_cname=StringVar()  #### name varible
        ...
        txt_name=Entry(CustomerFrame,textvariable=self.var_cname,font=("times ne roman",13,"bold"),bg="lightyellow").place(x=80, y=35,width=180)
        
        lbl_contact=Label(CustomerFrame,text="Contact No.",font=("times new roman",15),bg="white").place(x=270, y=35)
        txt_contact=Entry(CustomerFrame,textvariable=self.var_contact,font=("times ne roman",13,"bold"),bg="lightyellow").place(x=380, y=35,width=140)

        ########## Calculator_cart frame
        ...
        btn_7=Button(Cal_Frame,text='7',font=("arial",15,"bold"),command=lambda:self.get_input(7),width=4,bd=5,pady=10,cursor='hand2').grid(row=1,column=0)
        btn_8=Button(Cal_Frame,text='8',font=("arial",15,"bold"),command=lambda:self.get_input(8),width=4,bd=5,pady=10,cursor='hand2').grid(row=1,column=1)
        btn_9=Button(Cal_Frame,text='9',font=("arial",15,"bold"),command=lambda:self.get_input(9),width=4,bd=5,pady=10,cursor='hand2').grid(row=1,column=2)
        btn_sum=Button(Cal_Frame,text='+',font=("arial",15,"bold"),command=lambda:self.get_input('+'),width=4,bd=5,pady=10,cursor='hand2').grid(row=1,column=3)

        btn_4=Button(Cal_Frame,text='4',font=("arial",15,"bold"),command=lambda:self.get_input(4),width=4,bd=5,pady=10,cursor='hand2').grid(row=2,column=0)
        btn_5=Button(Cal_Frame,text='5',font=("arial",15,"bold"),command=lambda:self.get_input(5),width=4,bd=5,pady=10,cursor='hand2').grid(row=2,column=1)
        btn_6=Button(Cal_Frame,text='6',font=("arial",15,"bold"),command=lambda:self.get_input(6),width=4,bd=5,pady=10,cursor='hand2').grid(row=2,column=2)
        btn_sub=Button(Cal_Frame,text='-',font=("arial",15,"bold"),command=lambda:self.get_input('-'),width=4,bd=5,pady=10,cursor='hand2').grid(row=2,column=3)

        btn_1=Button(Cal_Frame,text='1',font=("arial",15,"bold"),command=lambda:self.get_input(1),width=4,bd=5,pady=10,cursor='hand2').grid(row=3,column=0)
        btn_2=Button(Cal_Frame,text='2',font=("arial",15,"bold"),command=lambda:self.get_input(2),width=4,bd=5,pady=10,cursor='hand2').grid(row=3,column=1)
        btn_3=Button(Cal_Frame,text='3',font=("arial",15,"bold"),command=lambda:self.get_input(3),width=4,bd=5,pady=10,cursor='hand2').grid(row=3,column=2)
        btn_mul=Button(Cal_Frame,text='*',font=("arial",15,"bold"),command=lambda:self.get_input('*'),width=4,bd=5,pady=10,cursor='hand2').grid(row=3,column=3)

        btn_0=Button(Cal_Frame,text='0',font=("arial",15,"bold"),command=lambda:self.get_input(0),width=4,bd=5,pady=15,cursor='hand2').grid(row=4,column=0)
        btn_c=Button(Cal_Frame,text='c',font=("arial",15,"bold"),command=self.clear_cal,width=4,bd=5,pady=15,cursor='hand2').grid(row=4,column=1)
        btn_eq=Button(Cal_Frame,text='=',font=("arial",15,"bold"),command=self.perform_cal,width=4,bd=5,pady=15,cursor='hand2').grid(row=4,column=2)
        btn_div=Button(Cal_Frame,text='/',font=("arial",15,"bold"),command=lambda:self.get_input('/'),width=4,bd=5,pady=15,cursor='hand2').grid(row=4,column=3)


        ####### Cart Frame
        cart_Frame= Frame(Cal_Cart_Frame,bd=3,relief=RIDGE)
        cart_Frame.place(x=280,y=8,width=245,height=342)
        self.cartTitle = Label(cart_Frame, text="Cart \t Total Products:[0]", font=("goudy old style", 15),bg="lightgray", fg="black")
        ...
        lbl_p_price=Label(Add_CartWidgetsFrame,text="Priceper Qty",font=("goudy old style", 15),bg="white").place(x=230, y=5)
        ...
        txt_p_qty=Entry(Add_CartWidgetsFrame,textvariable=self.var_qty,font=("goudy old style", 15),bg="white").place(x=390, y=35,width=120,height=22)
    ...
    def add_update_cart(self):
        if self.var_pid.get()=='':
            ...
            for row in self.cart_list:
                ...
                index_+=1
            if present=='yes':
                op=messagebox.askyesno('Confirm','Product already prdent\n Do you want to Update|Remove from Cart List',parent=self.root)
                if op==True:
                    if self.var_qty.get()=="0":
                        self.cart_list.pop(index_)
                    else:                                        #pid,name,price,qty,stock
